...
#define MOTION_UP 1 // Upward motion.
 ...
 // 
 // You can use any numeric values, as specified in the comments for each axis. 
// However,
// the MOTION_ definitions offer an easy way to define a "unit" movement without 
// using
// magic numbers (e.g. instead of setting Surge = 1, you can set Surge = 
// MOTION_FORWARD).
//
typedef struct {
 ...
 ******************************************************************************/
 // Represents the state of a single keyboard key.Represents the state of a single 
// keyboard key.
typedef enum {
...
// Note: USE ONLY LOWERCASE CHARACTERS HERE. The keyboard handler provided convertsall
